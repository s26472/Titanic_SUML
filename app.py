...
def main():
	...
	st.set_page_config(page_title="Sprawdź czy przeżyłbyś na Titanicu")
	overview = st.container()
	left, right = st.columns(2)
	prediction = st.container()

	st.image("https://upload.wikimedia.org/wikipedia/commons/9/9c/Titanic_wreck_bow.jpg")

	with overview:
		st.title("Sprawdź czy przeżyłbyś na Titanicu")
